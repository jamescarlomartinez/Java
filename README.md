...
- Social Fair remains the default rotation style. **Skill Balanced** uses Beginner, Novice, Low Intermediate, Intermediate, Advanced, and Expert / Pro levels to minimize the team-skill gap after game-count and waiting fairness.
- Every new player requires an explicit skill level. Migrated numeric ratings remain playable as provisional named levels until confirmed, and checked-in players can update only their own level.
